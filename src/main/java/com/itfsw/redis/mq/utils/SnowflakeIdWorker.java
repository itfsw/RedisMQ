...
public class SnowflakeIdWorker {
    private static SnowflakeIdWorker idWorker = new SnowflakeIdWorker(0);
    ...
    /**
     * 获得下一个ID (该方法是线程安全的)
     * @return 更符合阅读习惯的ID（yyyyMMddHHmmssSSS+suffix）
     */
    public synchronized String nextPerfectId() {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000; i++) {
            System.out.println(idWorker.nextPerfectId());
        }
    }
}
